class Annotator.Plugin.Reply extends Annotator.Plugin
	...
	# display details of annotation being replied to
	annotationEditorShown: (editor,annotations) ->
		console.log("editor shown", editor, annotations)

	# display how many replies in a field in the viewer
	...
	onReplyClick: (event) ->
		...
		# handlers for cancel and save buttons in editor
